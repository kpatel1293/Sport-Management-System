...
import edu.depaul.cdm.se.sportmanagementsystem.repository.GameScheduleRepository;
...
public class GameScheduleService {
    ...
    public List<GameSchedule> getAllGames() {
        ...
        gameScheduleRepository.findAll().forEach(gameSchedule -> gameSchedules.add(gameSchedule));
